...
public final class ColorLabelField extends LabelField {
	...
	public ColorLabelField(String text) {
		super(text);
		construct(Const.FONT, 0, Font.PLAIN, Const.FONTCOLOR, Const.BACKCOLOR, Const.FONTCOLOR);
	}
	...
	public ColorLabelField(String text, long style, int font) {
		super(text, style);
		construct(font, 0, Font.PLAIN, Const.FONTCOLOR, Const.BACKCOLOR, Const.FONTCOLOR);
	}
	public ColorLabelField(String text, int width, long style) {
		super(text, style);
		construct(Const.FONT, width, Font.PLAIN, Const.FONTCOLOR, Const.BACKCOLOR, Const.FONTCOLOR);
	}
	public ColorLabelField(String text, int fontsize, long style, int color) {
		super(text, style);
		construct(fontsize, 0, Font.PLAIN, color, Const.BACKCOLOR, Const.FONTCOLOR);
	}
	public ColorLabelField(String text, int fontsize, long style, int color, int width) {
		super(text, style);
		construct(fontsize, width, Font.PLAIN, color, Const.BACKCOLOR, Const.FONTCOLOR);
	}
	public ColorLabelField(String text, int color, int font, int fontsize, long style) {
		super(text, style);
		construct(fontsize, 0, font, color, Const.BACKCOLOR, Const.FONTCOLOR);
	}
