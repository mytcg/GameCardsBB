...
import net.mytcg.prg.custom.BackgroundManager;
import net.mytcg.prg.http.ConnectionGet;
...
public class AppScreen extends MainScreen {
	...
	protected BackgroundManager titleManager = new BackgroundManager(false) {
		...
		public void paint(Graphics g) {
			//g.drawBitmap((getPreferredWidth()-logo.getWidth())/2, 0, getPreferredWidth(), getPreferredHeight(), logo, 0, 0);
