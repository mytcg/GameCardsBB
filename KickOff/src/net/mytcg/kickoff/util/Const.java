...
import net.mytcg.kickoff.http.ConnectionHandler;
import net.mytcg.kickoff.ui.GameCards;
import net.mytcg.kickoff.ui.custom.ImageLoader;
...
public final class Const {
	...
	public static String PREFIX = "ko_";
	...
	public static final int SELECTEDCOLOR = 10027008;
	...
	public static String url = "http://www.mytcg.net/_phone/kickoff/?";
	...
	public static String auctioncategories="auctioncategories2=1";
	...
	private static Bitmap albumthumbselected;
	private static String sz_albumthumbselected = "Album_thumb_selected.png";
	public static Bitmap getAlbumThumbSelected() {
		if (albumthumbselected == null) {
			albumthumbselected = getSizeImage(sz_albumthumbselected);   
		}
		return albumthumbselected;
	}
	...
	private static Bitmap auctionsthumbselected;
	private static String sz_auctionsthumbselected = "Auctions_thumb_selected.png";
	public static Bitmap getAuctionsThumbSelected() {
		if (auctionsthumbselected == null) {
			auctionsthumbselected = getSizeImage(sz_auctionsthumbselected);   
		}
		return auctionsthumbselected;
	}
	...
	private static Bitmap creditsthumbselected;
	private static String sz_creditsthumbselected = "Credits_thumb_selected.png";
	public static Bitmap getCreditsThumbSelected() {
		if (creditsthumbselected == null) {
			creditsthumbselected = getSizeImage(sz_creditsthumbselected);   
		}
		return creditsthumbselected;
	}
	...
	private static String sz_compdecks = "Competition.png";
	...
	private static String sz_compdecksthumb = "Competition_thumb.png";
	...
	private static Bitmap compdecksthumbselected;
	private static String sz_compdecksthumbselected = "Competition_thumb_selected.png";
	public static Bitmap getCompDecksThumbSelected() {
		if (compdecksthumbselected == null) {
			compdecksthumbselected = getSizeImage(sz_compdecksthumbselected);   
		}
		return compdecksthumbselected;
	}
	...
	private static Bitmap friendsthumbselected;
	private static String sz_friendsthumbselected = "Friends_thumb_selected.png";
	public static Bitmap getFriendsThumbSelected() {
		if (friendsthumbselected == null) {
			friendsthumbselected = getSizeImage(sz_friendsthumbselected);   
		}
		return friendsthumbselected;
	}
	...
	private static Bitmap invitethumbselected;
	private static String sz_invitethumbselected = "Invite_thumb_selected.png";
	public static Bitmap getInviteThumbSelected() {
		if (invitethumbselected == null) {
			invitethumbselected = getSizeImage(sz_invitethumbselected);   
		}
		return invitethumbselected;
	}
	...
	private static Bitmap logoutthumbselected;
	private static String sz_logoutthumbselected = "Logout_thumb_selected.png";
	public static Bitmap getLogoutThumbSelected() {
		if (logoutthumbselected == null) {
			logoutthumbselected = getSizeImage(sz_logoutthumbselected);   
		}
		return logoutthumbselected;
	}
	...
	private static Bitmap notificationsthumbselected;
	private static String sz_notificationsthumbselected = "Notifications_thumb_selected.png";
	public static Bitmap getNotificationsThumbSelected() {
		if (notificationsthumbselected == null) {
			notificationsthumbselected = getSizeImage(sz_notificationsthumbselected);   
		}
		return notificationsthumbselected;
	}
	...
	private static Bitmap profilethumbselected;
	private static String sz_profilethumbselected = "Profile_thumb_selected.png";
	public static Bitmap getProfileThumbSelected() {
		if (profilethumbselected == null) {
			profilethumbselected = getSizeImage(sz_profilethumbselected);   
		}
		return profilethumbselected;
	}
	...
	private static Bitmap rankingsthumbselected;
	private static String sz_rankingsthumbselected = "Rankings_thumb_selected.png";
	public static Bitmap getRankingsThumbSelected() {
		if (rankingsthumbselected == null) {
			rankingsthumbselected = getSizeImage(sz_rankingsthumbselected);   
		}
		return rankingsthumbselected;
	}
	...
	private static Bitmap redeemthumbselected;
	private static String sz_redeemthumbselected = "Redeem_thumb_selected.png";
	public static Bitmap getRedeemThumbSelected() {
		if (redeemthumbselected == null) {
			redeemthumbselected = getSizeImage(sz_redeemthumbselected);   
		}
		return redeemthumbselected;
	}
	...
	private static Bitmap shopthumbselected;
	private static String sz_shopthumbselected = "Shop_thumb_selected.png";
	public static Bitmap getShopThumbSelected() {
		if (shopthumbselected == null) {
			shopthumbselected = getSizeImage(sz_shopthumbselected);   
		}
		return shopthumbselected;
	}
	...
	public static final int xml_children_length = xml_children.length();
	public static final String xml_children_end = "</children>";
	public static final int xml_children_end_length = xml_children_end.length();
