...
import net.mytcg.kickoff.ui.custom.BackgroundManager;
import net.mytcg.kickoff.ui.custom.ColorLabelField;
import net.mytcg.kickoff.ui.custom.HorizontalBackgroundManager;
...
public class AppScreen extends MainScreen {
	...
	protected ColorLabelField status = new ColorLabelField("", 10027008);
