...
import net.mytcg.kickoff.ui.custom.FriendField;
import net.mytcg.kickoff.ui.custom.ListItemField;
import net.mytcg.kickoff.ui.custom.ListLabelField;
import net.mytcg.kickoff.ui.custom.PageNumberField;
import net.mytcg.kickoff.ui.custom.ProfileFieldManager;
import net.mytcg.kickoff.ui.custom.SexyEditField;
import net.mytcg.kickoff.util.Answer;
	...
	public void process(String val) {
		...
		if (!(isDisplaying())) {
	    	...
	    	if ((fromIndex = val.indexOf(Const.xml_result)) != -1) {
	    		...
	    		int listSize = (Const.getUsableHeight()-5) / (Const.getButtonHeight()+14);
	    		int listCounter = 0;
	    		pages = new Vector();
	    		int answerid = -1;
	    		String desc = "";
