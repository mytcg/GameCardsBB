...
import net.mytcg.kickoff.ui.custom.MenuField;
import net.mytcg.kickoff.ui.custom.MenuThumbnailField;
import net.mytcg.kickoff.ui.custom.PageField;
import net.mytcg.kickoff.ui.custom.PageManager;
...
public class MenuScreen extends AppScreen implements FieldChangeListener
{
	...
	public MenuScreen()
	{
		...
		int listSize = (Const.getWidth()) / 74;
		int listCounter = 0;
		albums = new MenuThumbnailField(Const.getAlbumThumb(),Const.getAlbumThumbSelected(),Const.getAlbum(),menu);
		...
		compdecks = new MenuThumbnailField(Const.getCompDecksThumb(), Const.getCompDecksThumbSelected(),Const.getCompDecks(),menu);
		shop = new MenuThumbnailField(Const.getShopThumb(), Const.getShopThumbSelected(),Const.getShop(), menu);
		auctions = new MenuThumbnailField(Const.getAuctionsThumb(), Const.getAuctionsThumbSelected(),Const.getAuctions(),menu);
		//awards = new MenuThumbnailField(Const.getAwardsThumb(), Const.getAwards(),menu);
		redeem = new MenuThumbnailField(Const.getRedeemThumb(), Const.getRedeemThumbSelected(),Const.getRedeem(),menu);
		balance = new MenuThumbnailField(Const.getCreditsThumb(), Const.getCreditsThumbSelected(),Const.getCredits(),menu);
		profile = new MenuThumbnailField(Const.getProfileThumb(), Const.getProfileThumbSelected(),Const.getProfile(),menu);
		notifications = new MenuThumbnailField(Const.getNotificationsThumb(), Const.getNotificationsThumbSelected(),Const.getNotifications(),menu);
		rankings = new MenuThumbnailField(Const.getRankingsThumb(), Const.getRankingsThumbSelected(),Const.getRankings(),menu);
		//friendranks = new MenuThumbnailField(Const.getFriendRanksThumb(), Const.getFriendRanks(),menu);
		friends = new MenuThumbnailField(Const.getFriendsThumb(), Const.getFriendsThumbSelected(),Const.getFriends(),menu);
		invitefriend  = new MenuThumbnailField(Const.getInviteThumb(), Const.getInviteThumbSelected(),Const.getInvite(),menu);
		logout = new MenuThumbnailField(Const.getLogoutThumb(),Const.getLogoutThumbSelected(),Const.getLogout(),menu);
		...
		statusManager.setColor(2500134);
