package net.mytcg.phakama.util;
...
import net.mytcg.phakama.http.ConnectionHandler;
import net.mytcg.phakama.ui.GameCardsHome;
...
public final class Const {
	...
	public static String PREFIX = "phakama_";
