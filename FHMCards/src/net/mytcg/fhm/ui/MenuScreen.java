...
import net.mytcg.fhm.ui.custom.MenuField;
import net.mytcg.fhm.ui.custom.MenuThumbnailField;
import net.mytcg.fhm.ui.custom.PageField;
import net.mytcg.fhm.ui.custom.PageManager;
...
public class MenuScreen extends AppScreen implements FieldChangeListener
{
	...
	public MenuScreen()
	{
		...
		int listCounter = 0;
		albums = new MenuThumbnailField(Const.getAlbumThumb(),Const.getAlbumThumbSel(),Const.getAlbum(),menu);
		shop = new MenuThumbnailField(Const.getShopThumb(),Const.getShopThumbSel(), Const.getShop(), menu);
		auctions = new MenuThumbnailField(Const.getAuctionsThumb(),Const.getAuctionsThumbSel(), Const.getAuctions(),menu);
		redeem = new MenuThumbnailField(Const.getRedeemThumb(),Const.getRedeemThumbSel(), Const.getRedeem(),menu);
		balance = new MenuThumbnailField(Const.getCreditsThumb(),Const.getCreditsThumbSel(), Const.getCredits(),menu);
		profile = new MenuThumbnailField(Const.getProfileThumb(),Const.getProfileThumbSel(),Const.getProfile(),menu);
		notifications = new MenuThumbnailField(Const.getNotificationsThumb(),Const.getNotificationsThumbSel(), Const.getNotifications(),menu);
		friends = new MenuThumbnailField(Const.getFriendsThumb(), Const.getFriendsThumbSel(),Const.getFriends(),menu);
		invitefriend  = new MenuThumbnailField(Const.getInviteThumb(),Const.getInviteThumbSel(), Const.getInvite(),menu);
		logout = new MenuThumbnailField(Const.getLogoutThumb(),Const.getLogoutThumbSel(),Const.getLogout(),menu);
		...
		pages.addElement(tempList);
		statusManager.setColor(15134443);
