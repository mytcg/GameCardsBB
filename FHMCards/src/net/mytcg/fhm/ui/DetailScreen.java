...
import net.mytcg.fhm.ui.custom.FriendField;
import net.mytcg.fhm.ui.custom.ListItemField;
import net.mytcg.fhm.ui.custom.ListLabelField;
import net.mytcg.fhm.ui.custom.PageNumberField;
import net.mytcg.fhm.ui.custom.ProfileFieldManager;
import net.mytcg.fhm.ui.custom.SexyEditField;
import net.mytcg.fhm.util.Answer;
		...
		if (!(isDisplaying())) {
	    	...
	    	if ((fromIndex = val.indexOf(Const.xml_result)) != -1) {
	    		...
	    		if ((fromIndex = val.indexOf(Const.xml_premium)) != -1) {
    				credits = val.substring(fromIndex+Const.xml_premium_length, val.indexOf(Const.xml_premium_end, fromIndex));
