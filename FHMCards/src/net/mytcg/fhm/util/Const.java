...
import net.mytcg.fhm.http.ConnectionHandler;
import net.mytcg.fhm.ui.GameCardsHome;
import net.mytcg.fhm.ui.custom.ImageLoader;
...
public final class Const {
	...
	public static String PREFIX = "fhm_";
	...
	public static String credits = "Premium Credits";
	...
	public static String url = "http://www.mytcg.net/_phone/FHM/?";
	...
	public static boolean processUserDetails(String val) {
    	...
    	if ((fromIndex = val.indexOf(xml_userdetails)) != -1) {
    		...
    		if ((fromIndex = val.indexOf(xml_premium)) != -1) {
    			_instance.setCredits(val.substring(fromIndex+xml_premium_length, val.indexOf(xml_premium_end, fromIndex)));
    		}
	...
	private static Bitmap albumthumbsel;
	private static String sz_albumthumbsel = "Album_thumb_sel.png";
	public static Bitmap getAlbumThumbSel() {
		if (albumthumbsel == null) {
			albumthumbsel = getSizeImage(sz_albumthumbsel);   
		}
		return albumthumbsel;
	}
	...
	private static Bitmap auctionsthumbsel;
	private static String sz_auctionsthumbsel = "Auctions_thumb_sel.png";
	public static Bitmap getAuctionsThumbSel() {
		if (auctionsthumbsel == null) {
			auctionsthumbsel = getSizeImage(sz_auctionsthumbsel);   
		}
		return auctionsthumbsel;
	}
	...
	private static Bitmap creditsthumbsel;
	private static String sz_creditsthumbsel = "Credits_thumb_sel.png";
	public static Bitmap getCreditsThumbSel() {
		if (creditsthumbsel == null) {
			creditsthumbsel = getSizeImage(sz_creditsthumbsel);   
		}
		return creditsthumbsel;
	}
	...
	private static Bitmap friendsthumbsel;
	private static String sz_friendsthumbsel = "Friends_thumb_sel.png";
	public static Bitmap getFriendsThumbSel() {
		if (friendsthumbsel == null) {
			friendsthumbsel = getSizeImage(sz_friendsthumbsel);   
		}
		return friendsthumbsel;
	}
	...
	private static Bitmap invitethumbsel;
	private static String sz_invitethumbsel = "Invite_thumb_sel.png";
	public static Bitmap getInviteThumbSel() {
		if (invitethumbsel == null) {
			invitethumbsel = getSizeImage(sz_invitethumbsel);   
		}
		return invitethumbsel;
	}
	...
	private static Bitmap logoutthumbsel;
	private static String sz_logoutthumbsel = "Logout_thumb_sel.png";
	public static Bitmap getLogoutThumbSel() {
		if (logoutthumbsel == null) {
			logoutthumbsel = getSizeImage(sz_logoutthumbsel);   
		}
		return logoutthumbsel;
	}
	...
	private static Bitmap notificationsthumbsel;
	private static String sz_notificationsthumbsel = "Notifications_thumb_sel.png";
	public static Bitmap getNotificationsThumbSel() {
		if (notificationsthumbsel == null) {
			notificationsthumbsel = getSizeImage(sz_notificationsthumbsel);   
		}
		return notificationsthumbsel;
	}
	...
	private static Bitmap profilethumbsel;
	private static String sz_profilethumbsel = "Profile_thumb_sel.png";
	public static Bitmap getProfileThumbSel() {
		if (profilethumbsel == null) {
			profilethumbsel = getSizeImage(sz_profilethumbsel);   
		}
		return profilethumbsel;
	}
	...
	private static Bitmap redeemthumbsel;
	private static String sz_redeemthumbsel = "Redeem_thumb_sel.png";
	public static Bitmap getRedeemThumbSel() {
		if (redeemthumbsel == null) {
			redeemthumbsel = getSizeImage(sz_redeemthumbsel);   
		}
		return redeemthumbsel;
	}
	...
	private static Bitmap shopthumbsel;
	private static String sz_shopthumbsel = "Shop_thumb_sel.png";
	public static Bitmap getShopThumbSel() {
		if (shopthumbsel == null) {
			shopthumbsel = getSizeImage(sz_shopthumbsel);   
		}
		return shopthumbsel;
	}
